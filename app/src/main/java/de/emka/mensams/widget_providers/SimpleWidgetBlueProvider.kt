...
class SimpleWidgetBlueProvider: BalanceWidgetProvider() {
    ...
    override fun updateWidget(
        ...
        appWidgetIds.forEach { appWidgetId ->
            ...
            val textViews: RemoteViews = RemoteViews(
                ...
                setTextViewText(R.id.wb_tv_balance, BalanceUtils.intToString(balance))
                setTextViewText(R.id.wb_tv_date, date)
            }
